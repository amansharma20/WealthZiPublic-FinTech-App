...
import { CartAction } from '../../../persistence/actions/CartAction';
...
export default function OneTimePayment(props) {
    ...
    const modifyInvestmentAmount = (newAmount) => {
        console.log(minInvestment + newAmount)
    }
            ...
            <View style={styles.upperConatiner}>
                ...
                <View style={styles.buttonContainer}>
                    <View style={[styles.iconContainer, commanStyles.appShadow]}>
                        <TextInput
                            ...
                            maxLength={10}
                            onChangeText={text => updateTextField(text)}
                ...
                <View style={styles.amountsContainer}>
                    <View style={styles.amountsContainer2}>
                        <TouchableOpacity onPress={() => modifyInvestmentAmount(1000)}>
                        ...
                        <TouchableOpacity onPress={() => modifyInvestmentAmount(2000)}>
                            <View style={styles.amountView}>
                                <Text style={styles.amountRupeeText}>
                                    + ₹2000
                                </Text>
                        ...
                        <TouchableOpacity onPress={() => modifyInvestmentAmount(5000)}>
                            <View style={styles.amountView}>
                                <Text style={styles.amountRupeeText}>
                                    + ₹5000
                                </Text>
                    ...
                    <View style={styles.bottomIconContainer2}>
                        <TouchableOpacity onPress={() => {
                            let cartItem = {
                                ...
                                'scheme_code_bse': fund.scheme_code_bse
                            }
                            dispath(CartAction.addLumsumToCart('transactions', cartItem)).then(response => {
                                console.log("ADDED")
                            })
                        }}>
