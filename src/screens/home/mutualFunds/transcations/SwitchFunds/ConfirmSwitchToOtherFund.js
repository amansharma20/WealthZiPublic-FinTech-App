...
export default function ConfirmSwitchToOtherFund() {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                <View style={[styles.bottomIconContainer, commanStyles.appShadow]}>
                    <TouchableOpacity onPress={() => navigation.navigate('SwitchFail')} style={[styles.investView, commanStyles.appShadow]}>
