...
export default function SIPPayment(props) {
    ...
    const [selectedDuration, setDuration] = useState(null);


    const [sipArray, setArrayForSIP] = useState();

    let sipDatesArray = []
    function getSIPArray() {
        let s = fund.sip_date;
        s.split(',').forEach(character => {
            ...
            sipDatesArray.push(tempName);
        })
        setArrayForSIP(sipDatesArray);
    }
