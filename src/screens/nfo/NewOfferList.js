...
import FilterCardsModalSegments from '../explore/filters/FilterCardsModalSegments';
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={commanStyles.navBarTitle}>New Fund Offers</Text>
                <TouchableOpacity>
                    <FastImage style={{ width: 25, height: 25, flexDirection: 'column-reverse' }}
            ...
            <View style={styles.mutualFundsFlatListContainer}>
                {/* <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 30, marginTop: 20 }}>
                    ...
                    <Text style={styles.allMutualFundsLabel}>1 y </Text>
                </View> */}
                <FlatList
                    data={nfoList}
                    style={{ padding: 10 }}
